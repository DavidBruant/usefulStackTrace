...
module.exports = function trackStack(global){
    ...
    var uncaughtErrorFramePopHandler = (function(){
        ...
        return function(completionValue){
            ...
            // TODO re-init frameData if error is caught
            ...
            if('throw' in completionValue){
                ...
                thisFrameData.frameName = frameName(frame);
                ...
                if(frame.older === null || frame.older.type === 'global'){
                    console.group();
                    console.error('Uncaught error! Error message:', completionThrowValueToString(completionValue.throw) );
